...
public class OrderView extends AbstractEntityView {
    ...
    public OrderView(Entity restEntity, Entity profileEntity, Node viewNode, Node mainWindowNode) {
        ...
        Label headerLabel = new Label("내 레슨", "AddDishHeaderLabel");
        ...
        MultiButton addPromoCodeButton = new MultiButton("쿠폰 번호 입력");
        ...
        deliverToButton = new MultiButton("수강 장소");
        ...
        Label deliveryFeeHeaderLabel = new Label("수수료", "OrderDeliveryFeeHeader");
        ...
        Label itemTotalHeaderLabel = new Label("총 결제 금액: ", "ItemTotalHeader");
        ...
        Label totalHeaderLabel = new Label("총 결제 금액: ", "TotalCostHeader");
        ...
        Button confirmOrder = new Button("결제 확인", "OrderConfirmButton");
