...
public class FilterView extends AbstractEntityView{
    ...
    public FilterView(Entity filterEntity, Node viewNode) {
        ...
        Label headerLabel = new Label("필터 설정", "FilterHeaderLabel");
        ...
        Label categoryLabel = new Label("카테고리", "FilterHeader");
        add(categoryLabel);
        ...
        CategoryButton riceButton = new CategoryButton("코딩",
                "rice-icon.png",
        ...
        CategoryButton pizzaButton = new CategoryButton("운동",
                "pizza-icon.png",
        ...
        CategoryButton donutButton = new CategoryButton("음악",
                "donut-icon.png",
        ...
        CategoryButton chickenButton = new CategoryButton("요리",
                "chicken-icon.png",
        ...
        CategoryButton steakButton = new CategoryButton("입시",
                "steak-icon.png",
        ...
        CategoryButton mealButton = new CategoryButton("디자인",
                "meal-icon.png",
        ...
        CategoryButton kebabButton = new CategoryButton("게임",
                "kebab-icon.png",
        ...
        CategoryButton allButton = new CategoryButton("전체",
                "all-icon.png",
        ...
        Label sortByLabel = new Label("정렬 하기", "FilterHeader");
        add(sortByLabel);
        ...
        RadioButton fastDelivery = RadioButton.createToggle(" 빠른 예약순", FontImage.createMaterial(FontImage.MATERIAL_LOCAL_SHIPPING, sortByIconStyle), bg);
        ...
        RadioButton nearYou = RadioButton.createToggle(" 가까운 거리순", FontImage.createMaterial(FontImage.MATERIAL_LOCATION_ON, sortByIconStyle), bg);
        ...
        RadioButton trending = RadioButton.createToggle(" 트랜드", FontImage.createMaterial(FontImage.MATERIAL_TRENDING_UP, sortByIconStyle), bg);
        ...
        RadioButton popular = RadioButton.createToggle(" 인기순", FontImage.createMaterial(FontImage.MATERIAL_STAR_RATE, sortByIconStyle), bg);
        ...
        Button applyFilterButton = new Button("필터 적용", "FilterApplyButton");
