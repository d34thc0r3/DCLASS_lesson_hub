...
public class ProfileView<T extends Entity> extends AbstractEntityView<T> {
    ...
    public ProfileView(T account, Node mainWindowNode, Node appNode) {
        ...
        Label header = new Label("프로필", "ProfileHeader");
        ...
        MultiButton editProfile = new MultiButton("프로필 수정");
        ...
        MultiButton myAddressButton = new MultiButton("주소 관리");
        ...
        MultiButton paymentButton = new MultiButton("결제 수단");
        ...
        MultiButton logoutButton = new MultiButton("로그아웃");
