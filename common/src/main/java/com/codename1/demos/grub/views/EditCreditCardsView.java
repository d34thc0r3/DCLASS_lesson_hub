...
public class EditCreditCardsView extends AbstractEntityView {
    ...
    public EditCreditCardsView(Entity entity, Node viewNode) {
        ...
        Label headerLabel = new Label("결제 수단", "EditCreditCardsHeaderLabel");
        ...
        Label savedCards = new Label("저장된 카드", "SavedCardsHeader");
        add(savedCards);
        ...
        Label addCreditCardText = new Label("카드 추가", "AddCreditCardText");
