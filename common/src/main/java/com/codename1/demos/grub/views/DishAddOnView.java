...
public class DishAddOnView extends AbstractEntityView {
    ...
    public DishAddOnView(Entity entity, Node node) {
        ...
        // ✅ 여기서 출력되는 텍스트만 수정!
        nameLabel = new Button("레슨 옵션: " + entity.getText(nameProp), "DishAddOnName");
        priceLabel = new Label("추가 비용: " + Util.getPriceAsString(entity.getDouble(priceProp)), "DishAddOnPrice");
