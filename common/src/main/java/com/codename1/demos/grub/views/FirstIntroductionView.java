...
public class FirstIntroductionView extends AbstractEntityView {
    ...
    public FirstIntroductionView(Entity entity, Node grubNode, Node introNode) {
        ...
        Label header = new Label("당신의 멘토를 만나보세요", "IntroductionHeader");
        ...
        Button next = new Button("다음", "IntroductionNextButton");
        ...
        Button skip = new Button("건너뛰기", "IntroductionSkipButton");
