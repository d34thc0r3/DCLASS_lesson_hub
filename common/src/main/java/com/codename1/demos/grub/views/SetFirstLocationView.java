...
public class SetFirstLocationView extends AbstractEntityView {
    ...
    public SetFirstLocationView(Entity entity, Node viewNode) {
        ...
        Label enterLocationHeader = new Label("위치 입력", "SetFirstAddressHeader");
        ...
        TextField street = new TextField("", "도로명주소", 20, TextArea.ANY);
        street.setUIID("SetFirstLocationTextField");
        street.getHintLabel().setUIID("SetFirstLocationTextFieldHint");
        Button continueButton = new Button("계속", "SetFirstAddressNextButton");
        ...
        Button skipForNowButton = new Button("지금은 안볼래요", "SetFirstAddressSkipButton");
