...
public class EditPaymentView extends AbstractEntityView {
    ...
    public EditPaymentView(Entity paymentModel, Entity account, Node viewNode) {
        ...
        Label headerLabel = new Label("결제 수단 관리", "EditPaymentHeaderLabel");
        ...
        Label savedCardsHeader = new Label("등록된 카드", "SavedCardsHeader");
        ...
        Label anotherMethodHeader = new Label("다른 결제 수단 선택", "AnotherMethodHeader");
        add(anotherMethodHeader);

        MultiButton cashOnDeliveryButton = new MultiButton("현금 결제");
        ...
        MultiButton creditCardButton = new MultiButton("신용카드");
        ...
        MultiButton applePayButton = new MultiButton("애플 페이");
        ...
        MultiButton paypalButton = new MultiButton("페이팔");
