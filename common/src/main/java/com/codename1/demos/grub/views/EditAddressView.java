...
public class EditAddressView extends AbstractEntityView {
    ...
    public EditAddressView(AddressModel address, Node viewNode) {
        ...
        Label headerLabel = new Label("주소 수정", "EditAddressesHeaderLabel");
        ...
        TextField city = new TextField("", "도시", 20, TextArea.ANY);
        city.setUIID("AddressField");
        city.getHintLabel().setUIID("AddressFieldHint");

        TextField street = new TextField("", "구", 20, TextArea.ANY);
        street.setUIID("AddressField");
        street.getHintLabel().setUIID("AddressFieldHint");

        TextField freeText = new TextField("", "선택", 20, TextArea.ANY);
        ...
        RadioButton home = RadioButton.createToggle(" 집", FontImage.createMaterial(FontImage.MATERIAL_HOME, addressTypeStyle), bg);
        ...
        RadioButton work = RadioButton.createToggle(" 직장", FontImage.createMaterial(FontImage.MATERIAL_WORK, addressTypeStyle), bg);
        ...
        RadioButton other = RadioButton.createToggle(" 기타", FontImage.createMaterial(FontImage.MATERIAL_PLACE, addressTypeStyle), bg);
        ...
        CheckBox defaultAddress = new CheckBox("기본 주소로 설정");
        ...
        Button saveAddress = new Button("주소 저장", "SaveAddressConfirmButton");
